...
namespace AjudAkiWeb.Helpers
{
    ...
    public class EmailSender : IEmailSender
    {
        ...
        public Task SendEmailAsync(string email, string subject, string htmlMessage)
        {
            ...
            var imagePath = Path.Combine(_webRootPath, "img", "Logo_AjudAki.webp");
            ...
            <html>
                <body>
                    ...
                    <div style='text-align: center; font-size: 14px; color: #888888; margin-top: 20px; width: 100%; padding: 20px 0; background-color: #f1f1f1;'>
                        <p>&copy; 2024 - AjudAki- Todos os direitos reservados.</p>
                    </div>
                </body>
            </html>";
            ...
            var inlineLogo = new LinkedResource(imagePath, MediaTypeNames.Image.Webp)
            {
